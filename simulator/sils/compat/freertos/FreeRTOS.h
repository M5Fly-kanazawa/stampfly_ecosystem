 ...
 * P1.1（simulator/sils/rtos/）で足す。
 *
 * SILS convention: 1 tick = 1 ms (configTICK_RATE_HZ = 1000).
 * SILS の取り決め: 1 tick = 1 ms（configTICK_RATE_HZ = 1000）。
 */
...
// 1 tick = 1 ms on the SILS virtual clock.
// SILS の仮想時計では 1 tick = 1 ms。
...
// SILS: old-firmware files use xTaskGetTickCount etc. via FreeRTOS.h alone.
