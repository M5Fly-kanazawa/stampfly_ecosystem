 ...
 * @brief Canonical unit tests for the SILS frames module.
 *        SILS frames モジュールの正準単体テスト。
 *
...
using sils::frames::Vec3;
using sils::frames::Quat;
namespace F = sils::frames;
