...
"""Parse / generate SILS scenario (*.scn) files for the GUI scenario builder.

GUI のシナリオビルダー用に SILS シナリオ (*.scn) を双方向変換する。

The .scn grammar is owned by ``simulator/sils/devices/scenario.cpp`` (the parser the
