...
esp_err_t sils_espnow_set_recv_cb(esp_now_recv_cb_t cb);
esp_err_t sils_espnow_set_send_cb(esp_now_send_cb_t cb);
...
{
    sils_espnow_set_recv_cb(nullptr);
    sils_espnow_set_send_cb(nullptr);
    return ESP_OK;
}
                                     ...
                                     const uint8_t* data, size_t len)
{
    ...
    (void)data;
    (void)len;
    sils_espnow_report_send(peer_addr);
    return ESP_OK;
}
