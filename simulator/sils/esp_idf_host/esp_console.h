...
esp_err_t sils_console_register(const esp_console_cmd_t* c);
esp_err_t sils_console_dispatch(const char* cmdline, int* cmd_ret);
...
static inline esp_err_t esp_console_cmd_register(const esp_console_cmd_t* c) { return sils_console_register(c); }
static inline esp_err_t esp_console_run(const char* cmdline, int* ret) { return sils_console_dispatch(cmdline, ret); }
