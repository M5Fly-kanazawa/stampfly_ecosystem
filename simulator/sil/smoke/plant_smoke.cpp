 ...
 * @brief A/4 smoke — the SIL Plant hovers and synthesizes correct FRD sensors.
 *        A/4 スモーク — SIL Plant がホバーし、正しい FRD センサを合成する。
 *
...
int main(int argc, char** argv)
{
    ...
    sil::Plant::Truth t2 = plant2.truth();
