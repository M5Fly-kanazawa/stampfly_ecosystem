...
| Comms & logging | SSOT ControlPacket 14B, Telemetry UDP 50 Hz, **Data Stream 400 Hz wire-compatible with legacy** (`sf log wifi`/`viz` unmodified), Blackbox on SPIFFS, CLI over USB + TCP:23, WiFi STA/AP dual | Hardware E2E |
