...
| 資料 | 場所 |
|------|------|
| スライド本編（PDF） | `docs/workshop/slides/beamer/sci_tutorial.pdf`（`make sci` でビルド） |
| スライド（Docswell版・QRなし） | `docs/workshop/slides/beamer/sci_tutorial_docswell.pdf`（`make sci-docswell` でビルド） |
| 告知チラシ | `docs/sci_tutorial/チュートリアル講座2026広告最終案.pdf` |
...
| Material | Location |
|----------|----------|
| Main slide deck (PDF) | `docs/workshop/slides/beamer/sci_tutorial.pdf` (build with `make sci`) |
| Slides (Docswell variant, no QR codes) | `docs/workshop/slides/beamer/sci_tutorial_docswell.pdf` (build with `make sci-docswell`) |
| Announcement flyer | `docs/sci_tutorial/チュートリアル講座2026広告最終案.pdf` |
...
| 3 | Arm with the vehicle button and confirm the motors respond |
