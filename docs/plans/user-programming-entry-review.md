...
| Q9 | **既存資産をどう扱うか。** 例題 01〜12、Workshop、Blockly、Python SDK（2 系統）、大学シラバス系 | Workshop は現行基盤へアップグレード（2026-09-13）、`vehicle_old` はいずれ削除。`my_drone` と最上位 `examples/` の空ディレクトリは 2026-09-12 に削除済み | 候補一覧は `docs/plans/repository-cleanup-candidates.md` |
