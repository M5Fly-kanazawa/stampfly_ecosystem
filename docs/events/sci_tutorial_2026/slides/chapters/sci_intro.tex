...
% (setup_env -> sf doctor) stays in S2's "実習1"; these frames only preview
% the commands to type, one slide per OS, plus a slide showing what a
% successful sf doctor run looks like.
...
% ここではOS別に打つコマンドだけを先出しし、最後にsf doctorが成功した時の
% 表示例を示す1枚を添える。
