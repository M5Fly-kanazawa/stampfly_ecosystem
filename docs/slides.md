...
| 資料 | 説明 |
|------|------|
| [claude_code_workflow.pdf](bonus/claude_code_workflow/claude_code_workflow.pdf) | Claude Code ワークフロー |

## プレゼンテーション

| 資料 | 説明 |
|------|------|
| [presentation.pdf](assets/presentation.pdf) | プロジェクト紹介プレゼンテーション |
...
| Material | Description |
|----------|-------------|
| [claude_code_workflow.pdf](bonus/claude_code_workflow/claude_code_workflow.pdf) | Claude Code workflow |

## Presentation

| Material | Description |
|----------|-------------|
| [presentation.pdf](assets/presentation.pdf) | Project introduction presentation |
