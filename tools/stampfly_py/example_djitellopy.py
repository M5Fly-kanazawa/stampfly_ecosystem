"""
example_djitellopy.py — fly StampFly with the stock DJI Tello library, unchanged
example_djitellopy.py — 純正 DJI Tello ライブラリ（djitellopy）を無改変で StampFly に使う
...
Setup / 準備:
  ...
  3. python3 example_djitellopy.py
...
for corner in range(4):
    tello.move_forward(50)            # cm
    tello.rotate_clockwise(90)        # deg
